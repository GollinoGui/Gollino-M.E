...
contextBridge.exposeInMainWorld('api', {
  ...
  entradasMercadoria: {
    listar: (filtros) => ipcRenderer.invoke('entradasMercadoria:listar', filtros),
  ...
  gastosOperacionais: {
    ...
    marcarPago: (dados) => ipcRenderer.invoke('gastosOperacionais:marcarPago', dados),
    desmarcarPago: (dados) => ipcRenderer.invoke('gastosOperacionais:desmarcarPago', dados),
  },
  ...
  relatorios: {
    ...
    comprasVendasPorMes: (f) => ipcRenderer.invoke('relatorios:comprasVendasPorMes', f),
